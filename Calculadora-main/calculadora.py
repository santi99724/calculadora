...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla = Text(ventana, state="disabled", width=40, height=3, background="white", foreground="black",
                             font=("Helvetica", 15))
        ...
        botones = [boton1, boton2, boton3, boton4, boton5, boton6, boton7, boton8, boton9, boton10, boton11, boton12,
                   boton13, boton14, boton15, boton16, boton17, boton18]  # Agregamos el botón de potencia
        # Ubicar los botones con el gestor grid
        contador = 0
        for fila in range(1, 6):
            for columna in range(4):
                if contador < len(botones):  # Verificar si aún hay botones por colocar
